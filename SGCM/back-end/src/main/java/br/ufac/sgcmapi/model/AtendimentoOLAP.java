...
public class AtendimentoOLAP implements Serializable {
    ...
    private String pacientePossuiAusencias;
    ...
    public String getPacientePossuiAusencias() {
        return pacientePossuiAusencias;
    }
    public void setPacientePossuiAusencias(String pacientePossuiAusencias) {
        this.pacientePossuiAusencias = pacientePossuiAusencias;
    }
